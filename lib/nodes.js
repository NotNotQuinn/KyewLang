...
exports.DivideNode = exports.MultiplyNode = exports.SubtractNode = exports.AddNode = exports.FloatNode = exports.IntNode = exports.ValueNode = exports.BinaryOperatorNode = exports.UnaryOperatorNode = exports.BaseNode = void 0;
...
var AddNode = /** @class */ (function (_super) {
    ...
    AddNode.prototype.visit = function () {
...
var SubtractNode = /** @class */ (function (_super) {
    ...
    SubtractNode.prototype.visit = function () {
        return (this.child_1.visit() - this.child_2.visit());
    };
    return SubtractNode;
}(BinaryOperatorNode));
...
var MultiplyNode = /** @class */ (function (_super) {
    ...
    MultiplyNode.prototype.visit = function () {
        return (this.child_1.visit() * this.child_2.visit());
    };
    return MultiplyNode;
}(BinaryOperatorNode));
...
var DivideNode = /** @class */ (function (_super) {
    ...
    DivideNode.prototype.visit = function () {
        return (this.child_1.visit() / this.child_2.visit());
    };
    return DivideNode;
}(BinaryOperatorNode));
