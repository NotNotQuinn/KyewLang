...
err2.setTrace("These words are not allowed.", new t.SourceLine({ line: 4, from: 37, length: 11, source: source }));
err3.setTrace("There* oops", new t.SourceLine({ line: 7, from: 1, length: 4, source: source }));
err4.setTrace("an* oops", new t.SourceLine({ line: 8, from: 9, length: 1, source: source }));
err5.setTrace("a* oops. This is a very long error message, I mean like Its very long. I am testing to see how the wrapping works in the terminal. I think this should be about enough to do that.", new t.SourceLine({ line: 9, from: 9, length: 2, source: source }));
err.child = err2;
err2.child = err3;
err3.child = err4;
err4.child = err5;
