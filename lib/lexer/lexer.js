...
var tokens_1 = require("../custom/tokens");
var Trace = __importStar(require("../custom/trace/stacktrace"));
            ...
            case lexer_state_1.LexerState.LOOKING:
                switch (this.curChar) {
                    ...
                    case "\n":
                        ...
                        this.curTokenStart = this.curPos;
                        this.curTokenType = tokens_1.TokenType.NewlineToken;
                        this.buf += this.curChar;
                        this.curPos++;
                        break;
                    case ";":
                        this.state = lexer_state_1.LexerState.CREATE_TOKEN;
                        this.curTokenStart = this.curPos;
                        this.curTokenType = tokens_1.TokenType.PunctuationToken;
                        this.buf += this.curChar;
                        this.curPos++;
                        break;
                    // lowecase
            ...
            case lexer_state_1.LexerState.NUMBER:
                switch (this.curChar) {
                    ...
                    case "9":
                        ...
                        break;
                    default:
                        this.curTokenType = tokens_1.TokenType.IntToken;
                        this.state = lexer_state_1.LexerState.CREATE_TOKEN;
                }
                break;
            case lexer_state_1.LexerState.NUMBER_WITH_DECIMAL:
                switch (this.curChar) {
                    ...
                    case "9":
                        ...
                        break;
                    default:
                        this.curTokenType = tokens_1.TokenType.FloatToken;
                        this.state = lexer_state_1.LexerState.CREATE_TOKEN;
                }
                break;
            case lexer_state_1.LexerState.KEYWORD_MATCH:
                switch (this.curChar) {
                    ...
                    case "_":
                        ...
                        break;
                    default:
                        this.curTokenType = tokens_1.TokenType.KeywordToken;
                        this.state = lexer_state_1.LexerState.CREATE_TOKEN;
                }
                break;
            case lexer_state_1.LexerState.IDENTIFIER_OR_KEYWORD:
                ...
                switch (this.curChar) {
                    ...
                    case "_":
                        ...
                        break;
                    default:
                        this.curTokenType = tokens_1.TokenType.IdentifierToken;
                        this.state = lexer_state_1.LexerState.CREATE_TOKEN;
                }
                break;
